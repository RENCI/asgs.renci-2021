...
QSCRIPTTEMPLATE=$SCRIPTDIR/config/2023/ncfs-dev/qscript.template.renci.ht1
TDS=( renci_tds-k8-prod renci_tds-k8-dev )
...
COLDSTARTDATE=2023030100  # calendar year month day hour YYYYMMDDHH24
...
TIDEFAC=on               # tide factor recalc
   HINDCASTLENGTH=21.0   # length of initial hindcast, from cold (days)
...
FINISH_NOWCAST_SCENARIO=( output/opendap_post_nowcast_k8.sh ) # output/run_adda.sh )
